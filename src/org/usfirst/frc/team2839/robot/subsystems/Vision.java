...
public class Vision extends Subsystem implements Runnable {  //in Smart Dashboard must change properties of cameras to "switcher"
	...
	public void run() {
		...
		frontCamera = cameraServer.startAutomaticCapture(0);  //startAutomaticCapture(1); //originally (0)
		//Sets resolution and frame rate of frontCamera
        frontCamera.setResolution(320, 240);
        frontCamera.setFPS(30);
        //Starts capture of the rearCamera
        rearCamera = cameraServer.startAutomaticCapture(1);  //startAutomaticCapture(0); //originally (1)
