 ...
 *
 */
public class SpinnerPID extends PIDSubsystem {
	double output = 0.0;
    ...
    public  void enable()  {
    	...
    	double maxSpeed = RobotPreferences.spinMaxSpeed();
    ...
    protected double returnPIDInput() {
        ...
        return Robot.drivetrain.getEncoderRate();
    }
    ...
    public boolean onRawTargrt() {
    	if(Math.abs(getPIDController().getSetpoint() - Robot.drivetrain.getEncoderRate()) < tolerance) {
